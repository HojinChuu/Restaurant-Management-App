...
class ReportController extends Controller
{
    ...
    public function show(Request $request) 
    {
        ...
        return view('report.showReport')->with([
            'dateStart' => date("m/d/Y H:i:s", strtotime($request->dateStart.' 00:00:00')),
            'dateEnd' => date("m/d/Y H:i:s", strtotime($request->dateEnd.' 23:59:59')),
